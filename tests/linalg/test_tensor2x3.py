...
from neumann.linalg import ReferenceFrame, Tensor2x3
from neumann.linalg.exceptions import TensorShapeMismatchError
from neumann.linalg.testing import LinalgTestCase
...
class TestTensor2x3Create(LinalgTestCase):
    ...
    def test_create_failing_property(self):
        ...
        self.assertFailsProperly(TensorShapeMismatchError, Tensor2x3, array, frame=frame, bulk=True)
        ...
        self.assertFailsProperly(TensorShapeMismatchError, Tensor2x3, array, frame=frame, bulk=False)
