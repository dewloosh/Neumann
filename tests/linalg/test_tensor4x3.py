...
from neumann.linalg import ReferenceFrame, Tensor4x3
...
class TestTensor4x3Create(LinalgTestCase):
    ...
    def test_create_failing_property(self):
        ...
        self.assertFailsProperly(TensorShapeMismatchError, Tensor4x3, array, frame=frame, bulk=True)
        ...
        self.assertFailsProperly(TensorShapeMismatchError, Tensor4x3, array, frame=frame, bulk=False)
