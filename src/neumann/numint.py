...
__all__ = ['Quadrature', 'gauss_points', 'gauss_points_1d', 
           'gauss_points_2d', 'gauss_points_3d']
...
def gauss_points(*args):
    ...
    *args : tuple
    ...
    >>> from neumann.numint import gauss_points
    >>> gauss_points(2)
    ...
    if nD == 1:
        ...
        raise NotImplementedError("Currently there is no implementation for dimensions higher than 3.")
