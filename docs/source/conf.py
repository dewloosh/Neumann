...
def setup(app):
    ...
    app.registry.source_suffix.pop(".rst", None)
...
latex_documents = [
    ('index', 'Neumann.tex', u'Neumann Documentation',
     u'Bence Balogh', 'manual'),
]
...
man_pages = [
    ('index', 'neumann', u'Neumann Documentation',
     [u'Bence Balogh'], 1)
]
...
texinfo_documents = [
    ('index', 'Neumann', u'Neumann Documentation',
     u'Bence Balogh', 'Neumann', 'One line description of project.',
     'Miscellaneous'),
]
...
sphinx_gallery_conf = {
    ...
    #'junit': os.path.join('neumann', 'junit-results.xml'),
...
"""html_context = {
    ...
    'versions': (
        ('dev', 'https://github.com/dewloosh/Neumann/tree/main'),
        ('stable', 'https://github.com/dewloosh/Neumann/tree/main'),
    )
}"""